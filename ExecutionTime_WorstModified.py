...
plt.scatter(xs, ys4, color='#4A6C6F', s=10)
plt.plot(xs, ys4, color='#4A6C6F', label='Minmax_HeapSelect')
...
plt.scatter(xs, ys2, color='#A23E48', label='QuickSelect', s=10)
...
ax6.plot(xs, ys5, color='#FFAD0A', linestyle='-', linewidth=2.5 , alpha=0.50)
...
# TEMPI DI ESECUZIONE NEL CASO PEGGIORE LOGARITMICO
