...
fig20.suptitle("Tempo di esecuzione MedianOfMediansSelect (log)")
plt.scatter(xs, ys5, color='#FFAD0A', s=20)
plt.plot(xs, ys5, color='#FFAD0A', linewidth=2.5, label='MedianOfMediansSelect')
ax20.plot(xs, a5*nxs+b5, color='#404040', linestyle='dashed', linewidth=2.5, alpha=0.50, label='O(n)') # O(n)
ax20.set(xlabel='Dimensione dell\'input (log)', ylabel='Tempo medio di esecuzione (secondi)')
ax20.set_xscale("log")
ax20.set_yscale("log")
ax20.grid(True)
...
plt.scatter(xs, ys2, color='#A5B592', label='Randomized QuickSelect', s=20)
