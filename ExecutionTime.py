...
ax6.plot(xs, ys2, color='#A23E48', linestyle='-', linewidth=2.5)
...
plt.scatter(xs, ys2, color='#A23E48', label='QuickSelect', s=20)
ax16.plot(xs, ys2, color='#A23E48', linestyle='-', linewidth=2.5)
...
ax7.plot(xs, ys1, color='#A5B592', linestyle='-', linewidth=2.5)

plt.scatter(xs, ys4, color='#3BB273', label='MinMax HeapSelect', s=20)
ax7.plot(xs, ys4, color='#3BB273', linestyle='-', linewidth=2.5)
...
plt.scatter(xs, ys1, color='#A5B592', label='Randomized QuickSelect', s=20)
ax17.plot(xs, ys1, color='#A5B592', linestyle='-', linewidth=2.5)

plt.scatter(xs, ys4, color='#3BB273', label='MinMax HeapSelect', s=20)
ax17.plot(xs, ys4, color='#3BB273', linestyle='-', linewidth=2.5)

plt.scatter(xs, ys5, color='#FFAD0A', label='MedianodMediansSelect', s=20)
ax17.plot(xs, ys5, color='#FFAD0A', linestyle='-', linewidth=2.5)
