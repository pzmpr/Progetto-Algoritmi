...
def benchmark(n, maxv, k, inv, func, risoluzione, max_rel_error=0.001):
...
if __name__=="__main__":
    ...
    for i in range(iters):
        print(f"\r{i}",end='')
        n = int(nmin * (base ** i))
        points[i] = (n, benchmark(n, n, 1, 0, quickselect, risoluzione, 0.001),
                        benchmark(n, n, 0, 1, quickselect, risoluzione, 0.001),
                        benchmark(n, n, 1, 0, min_heapselect, risoluzione, 0.001),
                        benchmark(n, n, 1, 0, minmax_heapselect, risoluzione, 0.001),
                        benchmark(n, n, 1, 0, median_of_medians_select, risoluzione, 0.001))
...
# PROVA TRA INPUT CRESCENTE E DECRESCENTE
# Randomized Quickselect
fig1, ax1 = plt.subplots()
fig1.suptitle("Tempo di esecuzione QuickSelect")
ax1.scatter(xs, ys1, color='#A5B592', s=10)
ax1.plot(xs, ys1, color='#A5B592', label='QuickSelect normale')
ax1.scatter(xs, ys2, color='#A23E48', s=10)
ax1.plot(xs, ys2, color='#A23E48', label='QuickSelect inverso')
